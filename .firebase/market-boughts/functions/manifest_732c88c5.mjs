...
import {
  A as AstroError,
  n as ResponseSentError,
  q as MiddlewareNoDataOrNextCalled,
  t as MiddlewareNotAResponse,
  G as GetStaticPathsRequired,
  u as InvalidGetStaticPathsReturn,
  v as InvalidGetStaticPathsEntry,
  w as GetStaticPathsExpectedParams,
  x as GetStaticPathsInvalidRouteParam,
  P as PageNumberParamNotFound,
  y as GetStaticPathsRemovedRSSHelper,
  N as NoMatchingStaticPathFound,
  z as PrerenderDynamicEndpointPathCollide,
  B as LocalsNotAnObject,
  D as ASTRO_VERSION,
  C as ClientAddressNotAvailable,
  S as StaticClientAddressNotAvailable,
  F as renderEndpoint,
} from "./chunks/astro_af8d3f77.mjs";
import "html-escaper";
import "clsx";
...
function findPathItemByKey(staticPaths, params, route, logger) {
  ...
  logger.debug(
    "findPathItemByKey",
    `Unexpected cache miss looking for ${paramsKey}`,
  );
}
    ...
    if (
      ...
      for (const browserLocale of browserLocaleList) {
        const found = locales.find(
          (l) =>
            normalizeTheLocale(l) === normalizeTheLocale(browserLocale.locale),
        );
        if (found) {
          result.push(found);
        }
...
const manifest = deserializeManifest({
  ...
  routes: [
    ...
    },
    {
      file: "",
      links: [],
      scripts: [{ type: "external", value: "/_astro/hoisted.f958a9ec.js" }],
      styles: [],
      routeData: {
        route: "/signin",
        type: "page",
        pattern: "^\\/signin\\/?$",
        segments: [[{ content: "signin", dynamic: false, spread: false }]],
        params: [],
        component: "src/pages/signin.astro",
        pathname: "/signin",
        prerender: false,
        fallbackRoutes: [],
        _meta: { trailingSlash: "ignore" },
    ...
    },
    {
      ...
      routeData: {
        ...
        segments: [
          [{ content: "api", dynamic: false, spread: false }],
          [{ content: "auth", dynamic: false, spread: false }],
          [{ content: "signout", dynamic: false, spread: false }],
        ],
        params: [],
    ...
    },
    {
      ...
      routeData: {
        ...
        segments: [
          [{ content: "api", dynamic: false, spread: false }],
          [{ content: "auth", dynamic: false, spread: false }],
          [{ content: "signin", dynamic: false, spread: false }],
        ],
        params: [],
  ...
  componentMetadata: [
    [
      "/Users/f.moreno/Projects/market-boughts/src/pages/index.astro",
  ...
  entryModules: {
    ...
    "/src/pages/index.astro": "chunks/pages/index_52fad9b5.mjs",
    "/node_modules/astro/dist/assets/endpoint/node.js":
      "chunks/pages/node_8e1e3727.mjs",
    "/src/pages/register.astro": "chunks/pages/register_8ce99be7.mjs",
    "/src/pages/api/auth/register.ts": "chunks/pages/register_6629b5d5.mjs",
    "/src/pages/signin.astro": "chunks/pages/signin_ed5e9ee4.mjs",
    "/src/pages/api/auth/signin.ts": "chunks/pages/signin_9cd3a7f7.mjs",
    "/src/pages/api/auth/signout.ts": "chunks/pages/signout_1988db17.mjs",
    "\u0000@astrojs-manifest": "manifest_732c88c5.mjs",
    "\u0000@astro-page:node_modules/astro/dist/assets/endpoint/node@_@js":
      "chunks/node_56b1aec0.mjs",
    "\u0000@astro-page:src/pages/index@_@astro": "chunks/index_99eee715.mjs",
    "\u0000@astro-page:src/pages/dashboard@_@astro":
      "chunks/dashboard_5fcc9e21.mjs",
    "\u0000@astro-page:src/pages/register@_@astro":
      "chunks/register_fc511bbd.mjs",
    "\u0000@astro-page:src/pages/signin@_@astro": "chunks/signin_2e492440.mjs",
    "\u0000@astro-page:src/pages/api/auth/register@_@ts":
      "chunks/register_f8cf29b6.mjs",
    "\u0000@astro-page:src/pages/api/auth/signout@_@ts":
      "chunks/signout_e4cc2d55.mjs",
    "\u0000@astro-page:src/pages/api/auth/signin@_@ts":
      "chunks/signin_6b4b92da.mjs",
    "/astro/hoisted.js?q=0": "_astro/hoisted.f958a9ec.js",
    "astro:scripts/before-hydration.js": "",
  },
  assets: ["/favicon.svg", "/_astro/hoisted.f958a9ec.js"],
});
...
export {
  ...
  Logger as L,
  RouteCache as R,
  computePreferredLocaleList as a,
  computeCurrentLocale as b,
  computePreferredLocale as c,
  dateTimeFormat as d,
  redirectRouteStatus as e,
  redirectRouteGenerate as f,
  routeIsFallback as g,
  attachCookiesToResponse as h,
  createAPIContext as i,
  callEndpoint as j,
  callMiddleware as k,
  levels as l,
  AstroIntegrationLogger as m,
  manifest,
  getSetCookiesFromResponse as n,
  createRenderContext as o,
  routeIsRedirect as r,
};
